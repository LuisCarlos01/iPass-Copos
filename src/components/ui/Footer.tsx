...
export function Footer() {
  return (
    <footer className="bg-ipass-primary text-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* iPass E2Carbon */}
          <div>
            <h3 className="text-lg font-semibold mb-4">iPass E2Carbon</h3>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-green-100">contato@ipass.com.br</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span className="text-green-100">(35) xxxx-xxxx</span>
              </div>
            </div>

            {/* Logos */}
            <div className="mt-6 flex items-center space-x-4">
              <span className="text-xl font-bold italic">iPass!</span>
              <div className="flex items-center space-x-2">
              </div>
            </div>
          </div>
