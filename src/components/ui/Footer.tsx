...
export function Footer() {
  ...
  const handleSocialClick = (platform: string) => {
    const socialLinks = {
      ...
      linkedin: 'https://www.linkedin.com/company/ipass',
      facebook: 'https://www.facebook.com/ipass.oficial',
      twitter: 'https://twitter.com/ipass_oficial'
    };
  ...
  const handlePhoneClick = () => {
    window.location.href = 'tel:+5535000000000';
  };
  return (
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-xs text-white/60 font-medium">Telefone</p>
                  <p className="text-white/90 group-hover:text-white transition-colors duration-300">(35) xxxx-xxxx</p>
              </div>
              </button>
            </div>
          </div>
